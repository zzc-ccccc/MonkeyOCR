...
## News 
* ```2025.07.09 ``` 🚀 We release [MonkeyOCR-1.2B-0709](https://huggingface.co/echo840/MonkeyOCR-1.2B-0709), which achieves better overall performance compared to our previous 3B model.
...
python tools/download_model.py -n MonkeyOCR-3B-0709  # MonkeyOCR-1.2B-0709, MonkeyOCR
```
...
python tools/download_model.py -t modelscope -n MonkeyOCR-3B-0709   # MonkeyOCR-1.2B-0709, MonkeyOCR
```
### 3. Inference
